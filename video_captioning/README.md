...
```bash
# primary backend -- leave GEMINI_API_KEY blank to skip Gemini entirely and
# make Fireworks primary instead, no other change needed
GEMINI_API_KEY=...
GEMINI_VISION_MODEL=gemma-4-26b-a4b-it   # or gemma-4-31b-it -- verify against your account
...
- **Use dedicated keys for this image** (Gemini if you enable it, Fireworks,
  Groq), not your main accounts. If one leaks, you're revoking a key scoped
  to just this submission.
